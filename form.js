...
(SPForm.prototype.init = function () {
  ...
  return (
    jQ
      .get(t.ipSrvURL, function () {}, "jsonp")
      .always(function (r) {
        (t.ipInfo = r),
          (e = r && r.country_code ? r.country_code : ""),
        o.length &&
        (t.telInputInit = window.intlTelInput(o[0], {
          initialCountry: "auto",
          excludeCountries: ["ru"],
          separateDialCode: !0,
    ...
    t.previewMode ||
    t.$thanksBlock.on("click", function (e) {
      t.close(!0);
    }),
          ...
          switch (o.showOptions.condition) {
            ...
            case "onScroll":
              jQ(window).scroll(function () {
                (100 * (jQ(window).scrollTop() + jQ(window).height())) /
                jQ(document).height() >=
                o.showOptions.scrollTo && t();
              });
              break;
            case "onCursorLeave":
  ...
  (SPForm.prototype.validate = function (t) {
    ...
    if (!s)
      return t.showTip("required"), o.$submitButton.prop("disabled", !1), s;
    if (t.prop("required") && "" === n)
      return (
        (s = !1), t.showTip("required"), o.$submitButton.prop("disabled", !1), s
      );
    if (s && "" !== n && "phone" !== r)
      switch (r) {
        case "address":
  ...
  (SPForm.prototype.cbSubmit = function (t) {
    ...
    if (t.hasOwnProperty("html") && t.hasOwnProperty("status"))
      if (
        (e.$form.find(".sp-element-container").hide(), "success" === t.status)
      )
        ...
        void 0 !== e.showOptions.submitRedirectUrl &&
        e.showOptions.submitRedirectUrl.length > 0 &&
        (window.location = e.showOptions.submitRedirectUrl);
      else if ("verify" === t.status) {
        var o = e.showOptions.maDomain
        ...
        (e.sent = !0),
          ...
          (window.location.href =
            "//" + o + "/forms/recaptcha?hash=" + t.form_hash);
      } else
      ...
      e.$submitButton.addClass("btn-loading"),
        ...
        (function () {
          ...
          (e.preparedData.sform_lang = e.language),
            ...
            (e.preparedData["sform[" + window.btoa("autoSite") + "]"] =
              window.location.hostname),
          jQ.isEmptyObject(e.ipInfo) ||
          ((e.preparedData["sform[" + window.btoa("autoIp") + "]"] =
            e.ipInfo.ip),
            (e.preparedData["sform[" + window.btoa("autoCity") + "]"] =
              e.ipInfo.city),
            (e.preparedData["sform[" + window.btoa("autoRegion") + "]"] =
              e.ipInfo.region),
            (e.preparedData["sform[" + window.btoa("autoCountry") + "]"] =
              e.ipInfo.country)),
          "undefined" != typeof sbjs &&
          "undefined" !== e.showOptions.utmEnable &&
          !0 === e.showOptions.utmEnable &&
          ((e.preparedData["sform[" + window.btoa("visitFirstType") + "]"] =
            sbjs.get.first.typ),
...
!(function (t) {
  ...
  function o() {
    ...
    new Promise(function (t, r) {
      ...
      /*e.push(
    ResourceLoader.loadCss(
      s + "/apps/fc3/build/form-animations.css?1708945005535"
    )
  ),*/
      e.push(
        ResourceLoader.loadScript(
        ...
        /*e.push(
          ResourceLoader.loadCss(
            s + "/apps/fc3/build/form-defaults.css?1708945005535"
          )
        ),*/
        Promise.all(e).then(
          function () {
