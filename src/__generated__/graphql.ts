...
export type ComponentSectionsSecondaryBanner = {
  ...
  backgroundColor: Enum_Componentsectionssecondarybanner_Backgroundcolor;
...
export type Enum_Componentsectionssecondarybanner_Backgroundcolor =
  | 'background'
  | 'black'
  | 'primary'
  | 'secondary'
...
export type PagePageSectionsDynamicZone = ComponentSectionsBlocksGrid | ComponentSectionsCarousel | ComponentSectionsColumns | ComponentSectionsColumnsWithTabs | ComponentSectionsHeroBanner | ComponentSectionsImageBanner | ComponentSectionsInfoCardsTypeA | ComponentSectionsRichText | ComponentSectionsSecondaryBanner | ComponentSectionsWaveBanner | Error;
