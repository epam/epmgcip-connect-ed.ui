...
export type ComponentSectionsStatistics = {
  __typename?: 'ComponentSectionsStatistics';
  CTA?: Maybe<ComponentSharedButton>;
  ShowWave: Scalars['Boolean']['output'];
  StatisticsCards: Array<Maybe<StatisticsCard>>;
  StatisticsCards_connection?: Maybe<StatisticsCardRelationResponseCollection>;
...
export type ComponentSectionsStatisticsStatisticsCardsArgs = {
  filters?: InputMaybe<StatisticsCardFiltersInput>;
  pagination?: InputMaybe<PaginationArg>;
  sort?: InputMaybe<Array<InputMaybe<Scalars['String']['input']>>>;
};


export type ComponentSectionsStatisticsStatisticsCards_ConnectionArgs = {
  filters?: InputMaybe<StatisticsCardFiltersInput>;
  pagination?: InputMaybe<PaginationArg>;
  sort?: InputMaybe<Array<InputMaybe<Scalars['String']['input']>>>;
};
...
export type GenericMorph = Article | Button | ButtonTheme | Category | ColorScheme | Column | ComponentMetaMetadata | ComponentSectionsAccordion | ComponentSectionsBlocksGrid | ComponentSectionsCarousel | ComponentSectionsChart | ComponentSectionsColumns | ComponentSectionsColumnsWithTabs | ComponentSectionsContactBanner | ComponentSectionsEmailForm | ComponentSectionsGetInTouchForm | ComponentSectionsHeroBanner | ComponentSectionsImageBanner | ComponentSectionsInfoCardsTypeA | ComponentSectionsOverlayBlockTest | ComponentSectionsPersonellCards | ComponentSectionsRichText | ComponentSectionsSecondaryBanner | ComponentSectionsStatistics | ComponentSectionsTestimonials | ComponentSectionsTimeline | ComponentSectionsTopStripe | ComponentSectionsTwoColumns | ComponentSectionsWaveBanner | ComponentSectionsWaysToDonate | ComponentSharedAccordionItem | ComponentSharedArticleCategory | ComponentSharedButton | ComponentSharedCard | ComponentSharedColor | ComponentSharedColumnCard | ComponentSharedContactColumn | ComponentSharedGridBlock | ComponentSharedHeading | ComponentSharedImage | ComponentSharedImageCard | ComponentSharedLink | ComponentSharedMetaSocial | ComponentSharedNoodlesCard | ComponentSharedOverlayBlock | ComponentSharedPersonellcard | ComponentSharedSeo | ComponentSharedTestimonialsCard | ComponentSharedTimelineCard | ComponentSharedVideo | ComponentSharedWave | Footer | Header | I18NLocale | Image | Link | Page | ReviewWorkflowsWorkflow | ReviewWorkflowsWorkflowStage | SocialMedia | StatisticsCard | TabContainer | TabTheme | Theme | Title | UploadFile | UsersPermissionsPermission | UsersPermissionsRole | UsersPermissionsUser;
...
export type Mutation = {
  ...
  createStatisticsCard?: Maybe<StatisticsCard>;
  ...
  deleteStatisticsCard?: Maybe<DeleteMutationResponse>;
  ...
  updateStatisticsCard?: Maybe<StatisticsCard>;
...
export type MutationCreateStatisticsCardArgs = {
  data: StatisticsCardInput;
  locale?: InputMaybe<Scalars['I18NLocaleCode']['input']>;
  status?: InputMaybe<PublicationStatus>;
};
...
export type MutationDeleteStatisticsCardArgs = {
  documentId: Scalars['ID']['input'];
  locale?: InputMaybe<Scalars['I18NLocaleCode']['input']>;
};
...
export type MutationUpdateStatisticsCardArgs = {
  data: StatisticsCardInput;
  documentId: Scalars['ID']['input'];
  locale?: InputMaybe<Scalars['I18NLocaleCode']['input']>;
  status?: InputMaybe<PublicationStatus>;
...
export type PagePageSectionsDynamicZone = ComponentSectionsAccordion | ComponentSectionsBlocksGrid | ComponentSectionsCarousel | ComponentSectionsChart | ComponentSectionsColumns | ComponentSectionsColumnsWithTabs | ComponentSectionsContactBanner | ComponentSectionsEmailForm | ComponentSectionsGetInTouchForm | ComponentSectionsHeroBanner | ComponentSectionsImageBanner | ComponentSectionsInfoCardsTypeA | ComponentSectionsOverlayBlockTest | ComponentSectionsPersonellCards | ComponentSectionsRichText | ComponentSectionsSecondaryBanner | ComponentSectionsStatistics | ComponentSectionsTestimonials | ComponentSectionsTimeline | ComponentSectionsTopStripe | ComponentSectionsTwoColumns | ComponentSectionsWaveBanner | ComponentSectionsWaysToDonate | Error;
...
export type Query = {
  ...
  statisticsCards: Array<Maybe<StatisticsCard>>;
  statisticsCards_connection?: Maybe<StatisticsCardEntityResponseCollection>;
...
export type QueryStatisticsCardsArgs = {
  filters?: InputMaybe<StatisticsCardFiltersInput>;
  locale?: InputMaybe<Scalars['I18NLocaleCode']['input']>;
  pagination?: InputMaybe<PaginationArg>;
  sort?: InputMaybe<Array<InputMaybe<Scalars['String']['input']>>>;
...
export type QueryStatisticsCards_ConnectionArgs = {
  filters?: InputMaybe<StatisticsCardFiltersInput>;
  locale?: InputMaybe<Scalars['I18NLocaleCode']['input']>;
  pagination?: InputMaybe<PaginationArg>;
  sort?: InputMaybe<Array<InputMaybe<Scalars['String']['input']>>>;
...
export type StatisticsCard = {
  ...
  documentId: Scalars['ID']['output'];
  locale?: Maybe<Scalars['String']['output']>;
  localizations: Array<Maybe<StatisticsCard>>;
  localizations_connection?: Maybe<StatisticsCardRelationResponseCollection>;
  publishedAt?: Maybe<Scalars['DateTime']['output']>;
  theme?: Maybe<Theme>;
  title: Scalars['String']['output'];
  updatedAt?: Maybe<Scalars['DateTime']['output']>;
...
export type StatisticsCardLocalizationsArgs = {
  filters?: InputMaybe<StatisticsCardFiltersInput>;
  pagination?: InputMaybe<PaginationArg>;
  sort?: InputMaybe<Array<InputMaybe<Scalars['String']['input']>>>;
};
...
export type StatisticsCardLocalizations_ConnectionArgs = {
  filters?: InputMaybe<StatisticsCardFiltersInput>;
  pagination?: InputMaybe<PaginationArg>;
  sort?: InputMaybe<Array<InputMaybe<Scalars['String']['input']>>>;
};

export type StatisticsCardEntityResponseCollection = {
  __typename?: 'StatisticsCardEntityResponseCollection';
  nodes: Array<StatisticsCard>;
  pageInfo: Pagination;
};

export type StatisticsCardFiltersInput = {
  and?: InputMaybe<Array<InputMaybe<StatisticsCardFiltersInput>>>;
  createdAt?: InputMaybe<DateTimeFilterInput>;
  description?: InputMaybe<StringFilterInput>;
  documentId?: InputMaybe<IdFilterInput>;
  locale?: InputMaybe<StringFilterInput>;
  localizations?: InputMaybe<StatisticsCardFiltersInput>;
  not?: InputMaybe<StatisticsCardFiltersInput>;
  or?: InputMaybe<Array<InputMaybe<StatisticsCardFiltersInput>>>;
  publishedAt?: InputMaybe<DateTimeFilterInput>;
  theme?: InputMaybe<ThemeFiltersInput>;
  title?: InputMaybe<StringFilterInput>;
  updatedAt?: InputMaybe<DateTimeFilterInput>;
...
export type StatisticsCardInput = {
  description?: InputMaybe<Scalars['String']['input']>;
  publishedAt?: InputMaybe<Scalars['DateTime']['input']>;
  theme?: InputMaybe<Scalars['ID']['input']>;
  title?: InputMaybe<Scalars['String']['input']>;
...
export type StatisticsCardRelationResponseCollection = {
  __typename?: 'StatisticsCardRelationResponseCollection';
  nodes: Array<StatisticsCard>;
};
...
export type StatisticsSectionFragment = { __typename: 'ComponentSectionsStatistics', Summary: string, ShowWave: boolean, Theme?: { __typename?: 'Theme', documentId: string, title?: string | null, bgColor?: Enum_Theme_Bgcolor | null, color?: Enum_Theme_Color | null } | null, StatisticsCards: Array<{ __typename?: 'StatisticsCard', title: string, description: string, value: number, theme?: { __typename?: 'Theme', documentId: string, bgColor?: Enum_Theme_Bgcolor | null, color?: Enum_Theme_Color | null } | null } | null>, Title?: { __typename?: 'Title', HeadingLevel?: Enum_Title_Headinglevel | null, Title?: string | null } | null, CTA?: { __typename?: 'ComponentSharedButton', Type?: Enum_Componentsharedbutton_Type | null, Label?: string | null, URL?: string | null, ButtonTheme?: { __typename?: 'ButtonTheme', BackgrondColor?: Enum_Buttontheme_Backgrondcolor | null, FontColor?: Enum_Buttontheme_Fontcolor | null, OutlineColor?: Enum_Buttontheme_Outlinecolor | null } | null } | null };
...
export type WaysToDonateFragmentFragment = { __typename?: 'ComponentSectionsWaysToDonate', TabTheme?: { __typename?: 'TabTheme', ActiveBgColor?: Enum_Tabtheme_Activebgcolor | null, ActiveBorderColor?: Enum_Tabtheme_Activebordercolor | null, ActiveColor?: Enum_Tabtheme_Activecolor | null, BgColor?: Enum_Tabtheme_Bgcolor | null, BorderColor?: Enum_Tabtheme_Bordercolor | null, Color?: Enum_Tabtheme_Color | null } | null, heading?: { __typename?: 'ComponentSharedHeading', id: string, Alignment?: Enum_Componentsharedheading_Alignment | null, Level?: number | null, Title?: { __typename?: 'Title', HeadingLevel?: Enum_Title_Headinglevel | null, Title?: string | null, documentId: string } | null } | null, Tabs: Array<{ __typename?: 'TabContainer', Label?: string | null, Description?: string | null, documentId: string, Title?: { __typename?: 'Title', documentId: string, Title?: string | null, HeadingLevel?: Enum_Title_Headinglevel | null } | null, content: Array<{ __typename?: 'ComponentSharedArticleCategory' } | { __typename?: 'ComponentSharedCard', Title?: string | null, Text?: string | null, qrCodeLink?: string | null, Link?: { __typename?: 'Button', label?: string | null, type?: Enum_Button_Type | null, url?: string | null, buttonTheme?: { __typename?: 'ButtonTheme', documentId: string, BackgrondColor?: Enum_Buttontheme_Backgrondcolor | null, OutlineColor?: Enum_Buttontheme_Outlinecolor | null, FontColor?: Enum_Buttontheme_Fontcolor | null } | null } | null } | { __typename?: 'Error' } | null> } | null>, Theme?: { __typename?: 'Theme', color?: Enum_Theme_Color | null, bgColor?: Enum_Theme_Bgcolor | null } | null };
...
export const StatisticsSectionFragmentDoc = {"kind":"Document","definitions":[{"kind":"FragmentDefinition","name":{"kind":"Name","value":"StatisticsSection"},"typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"ComponentSectionsStatistics"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"__typename"}},{"kind":"Field","name":{"kind":"Name","value":"Summary"}},{"kind":"Field","name":{"kind":"Name","value":"Theme"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"documentId"}},{"kind":"Field","name":{"kind":"Name","value":"title"}},{"kind":"Field","name":{"kind":"Name","value":"bgColor"}},{"kind":"Field","name":{"kind":"Name","value":"color"}}]}},{"kind":"Field","name":{"kind":"Name","value":"StatisticsCards"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"theme"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"documentId"}},{"kind":"Field","name":{"kind":"Name","value":"bgColor"}},{"kind":"Field","name":{"kind":"Name","value":"color"}}]}},{"kind":"Field","name":{"kind":"Name","value":"title"}},{"kind":"Field","name":{"kind":"Name","value":"description"}},{"kind":"Field","name":{"kind":"Name","value":"value"}}]}},{"kind":"Field","name":{"kind":"Name","value":"Title"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"HeadingLevel"}},{"kind":"Field","name":{"kind":"Name","value":"Title"}}]}},{"kind":"Field","name":{"kind":"Name","value":"ShowWave"}},{"kind":"Field","name":{"kind":"Name","value":"CTA"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"Type"}},{"kind":"Field","name":{"kind":"Name","value":"Label"}},{"kind":"Field","name":{"kind":"Name","value":"URL"}},{"kind":"Field","name":{"kind":"Name","value":"ButtonTheme"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"BackgrondColor"}},{"kind":"Field","name":{"kind":"Name","value":"FontColor"}},{"kind":"Field","name":{"kind":"Name","value":"OutlineColor"}}]}}]}}]}}]} as unknown as DocumentNode<StatisticsSectionFragment, unknown>;
